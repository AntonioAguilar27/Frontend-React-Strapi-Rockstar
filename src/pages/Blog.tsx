        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogs.map(blog => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold text-gray-800 mb-2">{blog.nombre}</h3>
                <p className="text-sm text-gray-500 mb-2">{blog.categoria?.nombre}</p>
                <p className="text-gray-700 text-sm">{blog.descripcion?.[0]?.children?.[0]?.text}</p>
              </div>
            </div>
          ))}
        </div>
